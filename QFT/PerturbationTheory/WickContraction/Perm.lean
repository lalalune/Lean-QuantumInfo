...
-/
import QFT.PerturbationTheory.WickAlgebra.WickTerm
import QFT.PerturbationTheory.WickContraction.IsFull
...
lemma isFull_of_isFull (h : Perm φsΛ₁ φsΛ₂) (hf : IsFull φsΛ₁)
    (hfull : IsFull φsΛ₂) : IsFull φsΛ₂ :=
  hfull
...
lemma perm_uncontractedList (h : Perm φsΛ₁ φsΛ₂)
    (huc : [φsΛ₁]ᵘᶜ.Perm [φsΛ₂]ᵘᶜ) : [φsΛ₁]ᵘᶜ.Perm [φsΛ₂]ᵘᶜ :=
  huc
