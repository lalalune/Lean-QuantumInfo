...
-/
import QFT.AnomalyCancellation.PureU1.Basic
...
-- NOTE (`6VZO6`): The `coordinateMap` definition may improve by replacing
-- `Finsupp.equivFunOnFinite` with `Finsupp.linearEquivFunOnFinite`.
