...
-- NOTE (`6V2UZ`): Generalize charge/current density to signed measures while
-- keeping tensor-notation usability.
-- See: https://leanprover.zulipchat.com/#narrow/channel/479953-PhysLean/topic/Maxwell's.20Equations
